...
<body class="container-fluid">
    ...
    <form action="salvacalculadora.php" method="post" class="text-center mt-1">
      ...
      <label>+</label><input type="radio" name="operacao">     
     <label>-</label> <input type="radio" name="operacao">     
      <label>x</label><input type="radio" name="operacao">     
      <label>/</label><input type="radio" name="operacao"><br><br>    
