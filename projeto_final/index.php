...
<body>
    <header id="topo">
        ...
        <div class="container-table">
            <div class="content">
                <div id="formulario" class="formulario">
                    <div style="background-color:#FFF; width:max-content; padding: 15px; margin: 15px auto;">
                        <form action="controller/criarcadastro.php" method="post">
                            <div id="title">
                                <h1 id="title-form">Cadastre-se para adotar</h1>
                            ...
                            <div class="container-form">
                                ...
                                <div class="forma">
                                    <input class="input_form" type="password" name="confirmaSenha"
                            ...
                            <button class="send-buttons" name="action" value="create">adotar </button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="container-table">
            <button id="form-button" class="add_table"> adotar <i class="fa fa-plus" aria-hidden="true"></i>
            </button>
        </div>
        </div>
        </div>
        ...
        <nav id="menu">
            ...
            <ul>
                ...
                <li><a href="view/atualizar.php">atualizar</a></li>
                <li><a href="view/ExcluirDados.php">Excluir Dados</a></li>
            </ul>
        </nav>
    </header>
    <figure id="banner">
    ...
    <script src="controller/js/funcao.js"></script>
</body>
