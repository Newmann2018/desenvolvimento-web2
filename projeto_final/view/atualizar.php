...
<body>
    <header id="topo">
        ...
        <?php if ($temErro) { ?>
        <div class="mt-2 alert alert-danger text-center mt-1" role="alert"><?=$erro?></div>
        <?php } else if ($temSucesso) { ?>
        <div class= "mt-2 alert alert-success text-center mt-1" role="alert"><?=$sucesso?></div>
        <?php } ?>
        <div class="container-table">
            <div class="content">
                <div id="formulario" class="formulario">
                    <div style="background-color:#FFF; width:max-content; padding: 30px auto; margin: 30px auto;">
                        <form action="../controller/atualizar.controller.php" method="post">
                            <div id="title">
                                <h1 id="title-form">atualizar dados</h1>
                            ...
                            <div class="container-form">
                                ...
                                <div class="forma">
                                    <input class="input_form" type="password" name="novaSenha"
                                        placeholder="Digite sua NovaSenha" required>
                                </div>
                                <div class="forma">
                                    <input class="input_form" type="password" name="confimeNovaSenha"
                                        placeholder="confirme seu nova senha"  required>
                                </div>
                                <div class="forma">
                            ...
                            <button class="send-buttons" name="action" value="create">atualizar </button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="container-table">
            <button id="form-button" class="add_table"> atualizar <i class="fa fa-plus" aria-hidden="true"></i>
            </button>
        </div>
        </div>
        </div>
        ...
        <nav id="menu">
            ...
            <ul>
                ...
                <li><a href="ExcluirDados.php">Excluir Dados</a></li>
            </ul>
        </nav>
    </header>
    <figure id="banner">
    ...
    <script src="../controller/js/atualizar.js"></script>
</body>
